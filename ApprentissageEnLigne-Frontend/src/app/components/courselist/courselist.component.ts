...
export class CourselistComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.GetYoutubeCourses();
    this.GetWebSiteCourses();
    ...
    $("#youtubecoursecard").show()
    $("#websitecoursecard").show()
    $("#likedbtn").hide();
    $("#enrollsuccess").hide();
  ...
  getcoursedetails(coursename: string) {
    $("#youtubecoursecard").hide();
    $("#websitecoursecard").hide();
  ...
  GetYoutubeCourses() {
    ...
    this.userService.getYoutubeCourseList().subscribe(
      data => {
        this.youtubecourselist = data;
        console.log(this.youtubecourselist);
      });
  ...
  GetWebSiteCourses() {
    ...
    this.userService.getWebsiteCourseList().subscribe(
      data => {
        this.websitecourselist = data;
        console.log(this.websitecourselist);
      });
  ...
  RechercherByName(coursename: string) {
    this.userService.getCourseListByName(coursename).subscribe(
      data => {
        this.youtubecourselist = data.filter(course => course.coursetype === 'Youtube');
        this.websitecourselist = data.filter(course => course.coursetype === 'Website');
